...
export async function generateMetadata({ params }: LocalArticlePageProps): Promise<Metadata> {
  ...
  const isPremiumExperimentPage = PREMIUM_EXPERIMENT_ENABLED;
  ...
  return (
    <>
      ...
      <main id="home" className="overflow-x-clip bg-[#eceff3] text-[#101521]">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1560px] px-5 md:px-10 lg:px-14">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              <article className="rounded-[26px] border border-[#dfe5ef] bg-white p-6 shadow-[0_22px_42px_rgba(16,24,40,0.1)] md:p-8">
                ...
                <section className="mt-7 rounded-[22px] border border-[rgba(255,108,136,0.5)] bg-[linear-gradient(150deg,rgba(52,8,12,0.98),rgba(146,19,42,0.96)_44%,rgba(31,7,11,0.98)_100%)] p-5 shadow-[0_20px_34px_rgba(16,4,8,0.42),0_0_0_1px_rgba(255,70,106,0.18)]">
                ...
                {quickBullets.length > 0 ? (
                  <section className="mt-6 rounded-2xl border border-[rgba(255,108,136,0.5)] bg-[linear-gradient(145deg,rgba(52,8,13,0.97),rgba(132,17,38,0.95)_48%,rgba(31,7,11,0.98)_100%)] p-5 shadow-[0_16px_32px_rgba(13,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.18)]">
                  ...
                  return (
                    <section key={section.title} id={section.headingId} className="mt-9 border-t border-[#e9edf4] pt-7 scroll-mt-32">
                      ...
                      {isPremiumExperimentPage && (sectionIndex === 1 || sectionIndex === 3) ? (
                        <section className="mt-5 rounded-xl border border-[rgba(255,108,136,0.48)] bg-[linear-gradient(160deg,rgba(54,8,13,0.98),rgba(136,18,39,0.96)_52%,rgba(31,7,11,0.98)_100%)] p-4 shadow-[0_12px_24px_rgba(13,3,7,0.38),0_0_0_1px_rgba(255,70,106,0.18)]">
                ...
                <section
                  className={`mt-6 rounded-2xl p-5 ${
                    isPremiumExperimentPage
                      ? "border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(150deg,rgba(52,8,13,0.98),rgba(132,17,38,0.96)_48%,rgba(31,7,11,0.98)_100%)] shadow-[0_18px_30px_rgba(12,3,7,0.38),0_0_0_1px_rgba(255,70,106,0.2)]"
                ...
                <section
                  ...
                  className={`mt-9 rounded-2xl p-5 ${
                    isPremiumExperimentPage
                      ? "border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]"
                ...
                <section
                  className={`mt-8 rounded-2xl p-5 ${
                    isPremiumExperimentPage
                      ? "border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(148deg,rgba(52,8,12,0.98),rgba(132,17,38,0.96)_50%,rgba(31,7,11,0.98)_100%)] shadow-[0_18px_30px_rgba(12,3,7,0.38),0_0_0_1px_rgba(255,70,106,0.2)]"
              ...
              <aside id="zone-di-roma" className="space-y-4 xl:sticky xl:top-28 xl:self-start">
                ...
                <section
                  id="contatti"
                  className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]"
                >
                  <h2 className="text-[1rem] font-extrabold text-white">Serve una mano adesso?</h2>
        ...
        <div className="fixed inset-x-3 bottom-3 z-40 flex gap-2 rounded-2xl border border-[rgba(255,108,136,0.48)] bg-[linear-gradient(155deg,rgba(52,8,12,0.96),rgba(140,18,40,0.94)_52%,rgba(31,7,11,0.96)_100%)] p-2 shadow-[0_16px_26px_rgba(10,2,6,0.45),0_0_0_1px_rgba(255,70,106,0.16)] backdrop-blur md:hidden">
          <a
            href={`tel:${siteConfig.phoneInternational}`}
