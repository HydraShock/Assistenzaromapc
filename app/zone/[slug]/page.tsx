...
export default async function ServiceAreaPage({ params }: ServiceAreaPageProps) {
  ...
  const darkCardBaseClass =
    "rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]";
  const darkHeroAsideClass =
    "hidden rounded-[22px] border border-[rgba(255,116,144,0.54)] bg-[linear-gradient(158deg,rgba(56,8,13,0.98),rgba(150,19,43,0.96)_54%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_0_0_1px_rgba(255,132,164,0.32),0_18px_32px_rgba(10,2,6,0.45),0_0_36px_rgba(255,56,94,0.28)] lg:block";
        ...
        <section className="relative isolate min-h-[34vh] overflow-hidden border-b border-[#2d0b11] pt-24 sm:min-h-[40vh] sm:pt-28">
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1560px] px-6 pb-12 md:px-10 md:pb-14 lg:px-14">
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.45fr)_320px] lg:items-end">
              ...
              <aside className={darkHeroAsideClass}>
            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              <article className="rounded-[26px] border border-[#dfe5ef] bg-white p-6 shadow-[0_22px_42px_rgba(16,24,40,0.1)] md:p-8">
                <section className="grid gap-4 md:grid-cols-2">
                  <article className={darkCardBaseClass}>
                ...
                <section className={`mt-8 ${darkCardBaseClass}`}>
              ...
              <aside className="space-y-4 xl:sticky xl:top-28 xl:self-start">
                ...
                <section className={darkCardBaseClass}>
