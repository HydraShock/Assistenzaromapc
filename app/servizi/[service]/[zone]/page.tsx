...
export default async function ServiceZonePage({ params }: ServiceZonePageProps) {
  ...
  const trustChips = ["Disponibile 7/7", "Intervento in giornata", "Roma"];
  ...
  const relatedGuidesForCombo = localBlogPosts
    .filter((item) => item.zoneSlugs?.includes(area.slug) || item.serviceSlugs?.includes(service.slug))
    .slice(0, 4);
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.45fr)_320px] lg:items-end">
              ...
              <aside className="hidden rounded-[22px] border border-[rgba(255,116,144,0.54)] bg-[linear-gradient(158deg,rgba(56,8,13,0.98),rgba(150,19,43,0.96)_54%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_0_0_1px_rgba(255,132,164,0.32),0_18px_32px_rgba(10,2,6,0.45),0_0_36px_rgba(255,56,94,0.28)] lg:block">
                ...
                <p className="mt-2 text-sm leading-[1.55] text-[rgba(255,232,239,0.92)]">
                  Intervento rapido per {service.name.toLowerCase()} nella zona {area.zoneName}.
                </p>
                <a
            ...
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              <article className="rounded-[26px] border border-[#dfe5ef] bg-white p-6 shadow-[0_22px_42px_rgba(16,24,40,0.1)] md:p-8">
                <section className="grid gap-4 md:grid-cols-2">
                  <article className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                    <h2 className="text-xl font-extrabold text-white">Cosa include il servizio</h2>
                    <ul className="mt-4 space-y-2 text-[rgba(255,228,228,0.92)]">
                      {service.includes.map((item) => (
                        <li key={item} className="flex items-start gap-2">
                          <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#ff5f82]" />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <article className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                    <h2 className="text-xl font-extrabold text-white">Quartieri coperti in {area.zoneName}</h2>
                ...
                <section className="mt-8 border-t border-[#e9edf4] pt-7">
                  <h2 className="text-[1.24rem] font-extrabold text-[#182338]">Domande frequenti</h2>
                ...
                <section className="mt-8 grid gap-4 md:grid-cols-2">
                  <article className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                    <h2 className="text-lg font-extrabold text-white">Altri servizi in {area.zoneName}</h2>
                  ...
                  <article className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                    <h2 className="text-lg font-extrabold text-white">Stesso servizio in altre zone</h2>
                    <div className="mt-3 flex flex-wrap gap-2">
                ...
                {relatedGuidesForCombo.length > 0 ? (
                  <section className="mt-8 rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                    <h2 className="text-lg font-extrabold text-white">Guide collegate</h2>
              ...
              <aside className="space-y-4 xl:sticky xl:top-28 xl:self-start">
                <section className="rounded-2xl border border-[#dfe5ef] bg-white p-5 shadow-[0_14px_30px_rgba(16,24,40,0.08)]">
                  <h2 className="text-sm font-bold uppercase tracking-[0.14em] text-[#6a7488]">Riepilogo intervento</h2>
                  <ul className="mt-3 space-y-2 text-[0.95rem] leading-[1.58] text-[#32425e]">
                    <li className="flex items-start gap-2">
                      <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#c2184f]" />
                      <span>{service.name} con diagnosi rapida.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#c2184f]" />
                      <span>Copertura completa su {area.zoneName}.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#c2184f]" />
                      <span>Supporto 7/7 in base a disponibilita.</span>
                    </li>
                  </ul>
                </section>

                <section className="rounded-2xl border border-[rgba(255,108,136,0.52)] bg-[linear-gradient(152deg,rgba(52,8,12,0.98),rgba(142,18,41,0.96)_52%,rgba(32,7,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4),0_0_0_1px_rgba(255,70,106,0.2)]">
                  <h2 className="text-[1rem] font-extrabold text-white">Supporto immediato</h2>
