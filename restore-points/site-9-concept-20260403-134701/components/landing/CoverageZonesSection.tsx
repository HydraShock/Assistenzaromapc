...
export function CoverageZonesSection({
  backgroundImage = "/backgrounds/chat.webp",
  className,
  compactText = false,
  premium = false,
...
function LegacyCoverageZonesSection({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 bg-cover bg-center opacity-64 saturate-[1.48] contrast-[1.16]"
        style={{ backgroundImage: `url("${resolvedBackgroundImage}")` }}
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(180deg,rgba(42,1,1,0.56),rgba(18,0,0,0.7))]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(120%_85%_at_50%_6%,rgba(255,0,0,0.56),rgba(255,0,0,0)_62%)]"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1260px] px-5 md:px-8 lg:px-10">
        ...
        >
          ...
          <h2
            ...
            className="mx-auto mt-3 max-w-[13ch] text-[clamp(2.1rem,5.4vw,4.4rem)] font-extrabold leading-[0.94] tracking-[-0.03em] text-[#fff5f2]"
