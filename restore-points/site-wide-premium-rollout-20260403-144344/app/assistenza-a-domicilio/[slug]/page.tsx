          ...
          <div className="relative z-10 mx-auto w-full max-w-[1560px] px-5 md:px-10 lg:px-14">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              ...
              <aside id="zone-di-roma" className="space-y-4 xl:sticky xl:top-28 xl:self-start">
                ...
                <section
                  id="contatti"
                  className="rounded-2xl border border-[rgba(255,132,158,0.4)] bg-[linear-gradient(152deg,rgba(30,7,12,0.98),rgba(61,11,23,0.95)_52%,rgba(23,6,11,0.98)_100%)] p-5 shadow-[0_18px_32px_rgba(12,3,7,0.4)]"
                >
