...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className={cn(
            ...
            isCrimson ? "from-[#ff174f]" : "from-cyan-500",
          )}
        >
        ...
        <motion.div
          ...
          className={cn(
            ...
            isCrimson ? "to-[#ff174f]" : "to-cyan-500",
          )}
        >
        ...
        <div
          className={cn(
            ...
            isCrimson ? "bg-[#ff174f]" : "bg-cyan-500",
          )}
        ></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className={cn(
            ...
            isCrimson ? "bg-[#ff4d73]" : "bg-cyan-400",
          )}
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
      ...
      <div className={cn("relative z-50 flex -translate-y-80 flex-col items-center px-5", contentClassName)}>
        {children}
      </div>
    </div>
  );
