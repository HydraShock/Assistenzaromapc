          ...
          <div className="relative z-10 mx-auto w-full max-w-[1560px] px-5 md:px-10 lg:px-14">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              <article className="rounded-[26px] border border-[#dfe5ef] bg-white p-6 shadow-[0_22px_42px_rgba(16,24,40,0.1)] md:p-8">
                ...
                <section className="mt-6 rounded-2xl border border-[#ead4dc] bg-[#fff9fb] p-5">
                  <h2 className="text-[1.05rem] font-extrabold text-[#6f1c34]">Approfondisci per zona e servizio</h2>
                  <div className="mt-3 flex flex-wrap gap-2.5">
                    {post.relatedLinks.map((item) => (
                      <Link
                        key={`article-link-${item.label}`}
                        href={item.href}
                        className="rounded-full border border-[#e2a6b5] bg-white px-3 py-1.5 text-[0.84rem] font-semibold text-[#5c2340] transition-colors hover:bg-[#fff1f5]"
                      >
                        {item.label}
                      </Link>
                    ))}
                ...
                <section id="faq" className="mt-9 rounded-2xl border border-[#edd0d8] bg-[#fff5f8] p-5">
                  <h2 className="text-[1.22rem] font-extrabold text-[#711730]">Domande frequenti</h2>
                  <div className="mt-4 space-y-3">
                    {post.faq.map((item) => (
                      <details key={item.question} className="rounded-xl border border-[#efd7de] bg-white p-4">
