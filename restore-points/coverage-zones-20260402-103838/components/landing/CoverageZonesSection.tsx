...
function LegacyCoverageZonesSection({
  ...
  return (
    <section
      ...
      className={cn(
        "relative overflow-hidden bg-[#130103]",
        compactText ? "py-8 md:py-10 lg:py-12" : "py-10 md:py-12 lg:py-14",
        className,
      )}
    >
      <div className="pointer-events-none absolute left-1/2 top-0 z-[2] h-48 w-[82%] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,rgba(255,55,55,0.42),rgba(255,55,55,0)_74%)] blur-[32px]" />
      <div className="absolute inset-0 z-0">
        <Image
          ...
          sizes="100vw"
          quality={100}
          className="object-cover object-center opacity-30 blur-[1.1px] scale-[1.02]"
          priority={false}
          aria-hidden="true"
        />
      </div>
      <div className="absolute inset-0 z-0">
        <Image
          ...
          sizes="100vw"
          quality={100}
          className="coverage-main-photo object-cover object-center saturate-[0.92] contrast-[1.08] brightness-[0.58]"
          priority={false}
          aria-hidden="true"
        />
      </div>
      <div className="absolute inset-0 z-[1] bg-[radial-gradient(98%_72%_at_50%_6%,rgba(255,36,36,0.38),rgba(156,11,11,0.34)_42%,rgba(9,1,1,0.84)_90%)]" />
      <div className="absolute inset-0 z-[1] bg-[linear-gradient(180deg,rgba(20,1,1,0.08)_0%,rgba(20,1,1,0.42)_44%,rgba(7,0,0,0.82)_100%)]" />
      <div
        className="pointer-events-none absolute inset-0 z-[2] opacity-[0.18] mix-blend-screen"
        style={{
          backgroundImage: "url('/backgrounds/hero-bg-red.png')",
          backgroundPosition: "center",
          backgroundSize: "cover",
          filter: "saturate(1.1) contrast(1.08) brightness(0.52)",
        }}
      />
      <div className="pointer-events-none absolute inset-0 z-[2] bg-[radial-gradient(circle_at_82%_20%,rgba(255,88,88,0.26),rgba(255,88,88,0)_44%),radial-gradient(circle_at_20%_76%,rgba(237,36,36,0.24),rgba(237,36,36,0)_48%)]" />
      <div className="pointer-events-none absolute inset-0 z-[2] bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0)_60%,rgba(0,0,0,0.68)_100%)]" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1260px] px-5 md:px-8 lg:px-10">
        ...
        >
          <p className="inline-flex rounded-full border border-[rgba(255,150,150,0.45)] bg-[rgba(45,2,5,0.7)] px-4 py-1 text-[0.62rem] font-semibold tracking-[0.17em] text-[rgba(255,215,215,0.94)]">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-[0.66rem] font-semibold tracking-[0.12em] text-[rgba(255,205,205,0.82)] uppercase">
            {legacyTopBadges.map((badge, index) => (
              <span key={badge} className="inline-flex items-center">
                {index > 0 && <span className="mr-3 text-[rgba(255,122,122,0.72)]">•</span>}
                {badge}
              </span>
            ))}
          </div>
        ...
        <motion.div
          ...
          className="relative mt-5 overflow-hidden rounded-[26px] border border-[rgba(255,90,90,0.56)] bg-[linear-gradient(162deg,rgba(29,2,4,0.94),rgba(16,1,2,0.92)_56%,rgba(10,0,1,0.95)_100%)] px-3 py-3 shadow-[0_0_0_1px_rgba(255,90,90,0.16),0_0_24px_rgba(255,22,22,0.2),0_18px_38px_rgba(0,0,0,0.5)] md:px-4 md:py-4 lg:px-6 lg:py-6"
          style={{ fontFamily: "var(--font-inter)" }}
        >
          <span className="pointer-events-none absolute inset-x-[16%] top-0 h-px bg-[linear-gradient(90deg,rgba(255,112,112,0),rgba(255,142,142,0.9),rgba(255,112,112,0))]" />
          <span className="pointer-events-none absolute -left-8 top-8 h-28 w-28 rounded-full bg-[radial-gradient(circle,rgba(255,52,52,0.36),rgba(255,52,52,0)_74%)] blur-xl" />
          <span className="pointer-events-none absolute -right-8 bottom-9 h-28 w-28 rounded-full bg-[radial-gradient(circle,rgba(255,52,52,0.3),rgba(255,52,52,0)_74%)] blur-xl" />
            ...
            >
              <defs>
                <linearGradient id="coverage-wave-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  ...
                  <stop offset="35%" stopColor="rgba(255,132,132,0.56)" />
                  <stop offset="65%" stopColor="rgba(255,88,88,0.72)" />
            ...
            {legacyCoverageCards.map((card, index) => (
              <motion.article
                ...
                className={cn(
                  ...
                  "border-[rgba(255,102,102,0.66)] bg-[radial-gradient(140%_130%_at_50%_0%,rgba(255,42,42,0.28),rgba(72,6,10,0.92)_56%,rgba(21,2,4,0.98)_100%)]",
                  "shadow-[0_0_14px_rgba(255,34,34,0.24),0_12px_22px_rgba(0,0,0,0.46)] transition-all duration-300",
                  card.featured ? "z-[3] w-[236px] [box-shadow:0_0_24px_rgba(255,46,46,0.38),0_16px_24px_rgba(0,0,0,0.5)]" : "z-[2] w-[206px]",
                  card.desktopClass,
                )}
              >
                ...
                <span className="pointer-events-none absolute -top-7 right-2 h-16 w-16 rounded-full bg-[radial-gradient(circle,rgba(255,68,68,0.44),rgba(255,68,68,0)_72%)] blur-lg transition-opacity duration-300 group-hover:opacity-100 opacity-80" />
                ...
                <h3 className="mt-2 text-[clamp(1.03rem,1.18vw,1.22rem)] font-extrabold leading-[1.05] tracking-[-0.01em] text-[#fff4f4]">
                  {card.title}
                </h3>
                <div className="mt-2.5 flex flex-wrap gap-1">
                  {card.points.map((point) => (
                    <span
                      key={point}
                      className="rounded-full border border-[rgba(255,122,122,0.52)] bg-[rgba(255,38,38,0.16)] px-2 py-0.5 text-[0.64rem] font-semibold text-[rgba(255,230,230,0.95)]"
                    >
                      {point}
                    </span>
                  ))}
            ...
            {legacyCoverageCards.map((card, index) => (
              <motion.article
                ...
                className={cn(
                  ...
                  "border-[rgba(255,102,102,0.66)] bg-[radial-gradient(140%_130%_at_50%_0%,rgba(255,42,42,0.28),rgba(72,6,10,0.92)_56%,rgba(21,2,4,0.98)_100%)]",
                  card.featured ? "shadow-[0_0_22px_rgba(255,46,46,0.38),0_16px_28px_rgba(0,0,0,0.48)]" : "shadow-[0_0_14px_rgba(255,34,34,0.24),0_14px_26px_rgba(0,0,0,0.44)]",
                )}
              >
                <span className="pointer-events-none absolute inset-x-4 top-0 h-px bg-[linear-gradient(90deg,rgba(255,126,126,0),rgba(255,154,154,0.9),rgba(255,126,126,0))]" />
                <p className="inline-flex rounded-full border border-[rgba(255,155,155,0.46)] bg-[rgba(39,2,5,0.62)] px-2.5 py-0.5 text-[0.6rem] font-semibold tracking-[0.09em] text-[rgba(255,225,225,0.92)]">
                ...
                <h3 className="mt-2 text-[1.12rem] font-extrabold leading-[1.05] text-[#fff4f4]">{card.title}</h3>
                <div className="mt-2.5 flex flex-wrap gap-1">
                  {card.points.map((point) => (
                    <span
                      key={point}
                      className="rounded-full border border-[rgba(255,122,122,0.52)] bg-[rgba(255,38,38,0.16)] px-2 py-0.5 text-[0.66rem] font-semibold text-[rgba(255,230,230,0.95)]"
                    >
                      {point}
                    </span>
                  ))}
          ...
          <details className="group mt-3 overflow-hidden rounded-[14px] border border-[rgba(255,104,104,0.42)] bg-[linear-gradient(150deg,rgba(46,4,7,0.72),rgba(24,2,4,0.82))]">
            <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2 text-[0.66rem] font-semibold tracking-[0.12em] text-[rgba(255,206,206,0.88)] uppercase [&::-webkit-details-marker]:hidden">
              <span>Copertura estesa su tutta Roma</span>
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-[rgba(255,130,130,0.48)] bg-[rgba(255,18,18,0.18)] text-[0.82rem] leading-none transition-transform duration-300 group-open:rotate-45">
                +
              </span>
            </summary>
        ...
        <div className="mt-4 flex justify-center">
          <a
            href="#contatti"
            className="inline-flex items-center justify-center rounded-full border border-[rgba(255,151,151,0.66)] bg-[linear-gradient(145deg,#ff2222,#bf0616_58%,#78020d)] px-6 py-2 text-[0.9rem] font-bold text-[#fff9f9] shadow-[0_8px_18px_rgba(138,4,18,0.5),0_0_16px_rgba(255,36,36,0.4)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_24px_rgba(138,4,18,0.56),0_0_22px_rgba(255,36,36,0.46)]"
          >
