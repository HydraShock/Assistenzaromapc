...
export function PrimaryHeroSection({ showWaveDivider = false }: PrimaryHeroSectionProps) {
  ...
  useEffect(() => {
    ...
    const initFog = async () => {
      ...
      try {
        ...
        // Silent fallback: keep static gradients when Vanta cannot initialize.
      }
    };
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#9b1414]">
      ...
      <div ref={fogRef} className="absolute inset-0 z-0 hidden lg:block" />
      <div
        aria-hidden="true"
        className="absolute inset-0 z-0 hidden md:block opacity-65"
        style={{
          background:
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 z-0 hidden lg:block opacity-50"
        style={{
          background:
      ...
      />
      <div className="pointer-events-none absolute inset-0 z-[1] hidden md:block bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.22)_1.1px,transparent_0)] [background-size:56px_56px]" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1600px] flex-col px-6 pb-14 pt-6 md:px-10 lg:px-14">
        <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/45 bg-black/22 px-4 py-1.5 text-xs font-semibold tracking-[0.08em] text-white md:text-sm">
        ...
        <div className="relative flex flex-1 items-center">
          <div className="relative z-20 w-full max-w-[640px] lg:ml-[9%] lg:pt-10">
            <p className="inline-flex items-center gap-3 text-xs font-semibold tracking-[0.28em] text-[#efb1b1] md:text-sm">
              <span className="h-px w-7 bg-[#f0b0b0]/70" />
              DA TE IN TUTTA ROMA
              <span className="h-px w-7 bg-[#f0b0b0]/70" />
            </p>

            <h1 className="mt-6 text-[clamp(3rem,6.3vw,5.45rem)] font-extrabold uppercase leading-[0.92] text-white" style={{ fontFamily: "var(--font-space)" }}>
              SONO LA TUA
            ...
            <p className="mt-7 max-w-[500px] text-[1rem] leading-relaxed text-white/92 md:max-w-[545px] md:text-[1.23rem]">
            ...
            <p className="mt-9 text-[3.25rem] font-extrabold tracking-tight text-white md:text-[3.6rem]">
              3421872127
            </p>
          ...
          <div className="pointer-events-none absolute right-[-1%] top-1/2 hidden h-[760px] w-[640px] -translate-y-1/2 lg:block xl:right-[3%] xl:h-[800px] xl:w-[700px]">
            <div className="absolute -right-[16%] top-[52%] w-[760px] -translate-y-1/2">
              <Image
                ...
                height={800}
                loading="lazy"
                sizes="(max-width: 1279px) 620px, 760px"
